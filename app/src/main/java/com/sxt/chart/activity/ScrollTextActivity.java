...
import com.sxt.chart.view.MyHorizontalScrollView;
import com.sxt.chart.view.RuleView;
...
import com.sxt.chart.view.ruler.OnValueChangeListener;
import com.sxt.chart.view.ruler.Ruler;
...
//        findViewById(R.id.four).setOnClickListener(this);
        ...
        final RuleView ruleView = (RuleView) findViewById(R.id.rule_view);
        MyHorizontalScrollView horizontalScrollView = (MyHorizontalScrollView) findViewById(R.id.hor_scrollview);
        ...
        ruleView.onChangedListener(new RuleView.onChangedListener() {
            ...
            public void onSlide(float number) {
                ...
                TextView select = findViewById(R.id.rulerSelect);
                select.setText(String.valueOf(text));
            }
