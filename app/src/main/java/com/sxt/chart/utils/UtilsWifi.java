 ...
 */
public class UtilsWifi extends AbsUtil {

    private static final String TAG = "UtilsWifi";
    private static WifiManager mWifiManager = (WifiManager) mCtx.getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnect() {
        NetworkInfo mNetworkInfo = ((ConnectivityManager) mCtx.getSystemService(Context.CONNECTIVITY_SERVICE)).getNetworkInfo(ConnectivityManager.TYPE_WIFI);
