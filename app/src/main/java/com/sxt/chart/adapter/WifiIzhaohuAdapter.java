...
public class WifiIzhaohuAdapter extends RecyclerView.Adapter {

    private Context context;
    private ArrayList<ScanResult> scanResults;
    private OnItemClickListener onItemClickListener;

    public WifiIzhaohuAdapter(Context context, ArrayList<ScanResult> scanResults) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.tvWifiName.setText(scanResult.SSID.replaceAll("\"", ""));
        holder.root.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(position, holder, scanResult);
                }
            }
        });
    }
    ...
    public void notifyAdapter(ArrayList<ScanResult> scanResults) {
        this.scanResults = scanResults;
