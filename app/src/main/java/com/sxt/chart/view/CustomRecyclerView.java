...
public class CustomRecyclerView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        emptyViewLayout.setLayoutParams(new CustomRecyclerView.LayoutParams(CustomRecyclerView.LayoutParams.MATCH_PARENT, CustomRecyclerView.LayoutParams.WRAP_CONTENT));
