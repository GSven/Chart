 ...
 */
public class RulerViewLast extends View {
    ...
    public RulerViewLast(Context context) {
        this(context, null);
    }

    public RulerViewLast(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RulerViewLast(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public RulerViewLast setTextColor(int color) {
        mTextPaint.setColor(color);
        invalidate();
        return this;
    }

    public RulerViewLast setTextSize(float textSize) {
        mTextPaint.setTextSize(textSize);
        invalidate();
        return this;
    }

    public RulerViewLast setTextMarginTop(float marginTop) {
        mTextMarginTop = marginTop;
        invalidate();
        return this;
    }

    public RulerViewLast setLineColor(int color) {
        mLinePaint.setColor(color);
        invalidate();
        return this;
    }

    public RulerViewLast setLineWidth(float width) {
        mLineWidth = width;
        invalidate();
        return this;
    }

    public RulerViewLast setLineSpaceWidth(float width) {
        mLineSpaceWidth = width;
        invalidate();
        return this;
    }

    public RulerViewLast setLineMinHeight(float height) {
        mLineMinHeight = height;
        invalidate();
        return this;
    }

    public RulerViewLast setLineMidHeight(float height) {
        mLineMidHeight = height;
        invalidate();
        return this;
    }

    public RulerViewLast setLineMaxHeight(float height) {
